...
from find_training_genes_scores_functions import make_csv, random_select, find_pos_neg_input, divide_5fold, find_pos_neg_chunks, define_training_test, find_GO_ont, find_GO_score_matrix, find_input_gene_GO_scores
...
pos, neg=find_pos_neg_input(syngo_file, index_file, GO_genes)
print ('pos', len(pos), 'neg', len(neg))
pos_df=make_csv(pos, 'updated', 'positives')
